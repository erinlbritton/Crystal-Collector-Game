 ...
 $(document).ready(function() {
        ...
        // Ends game with either win or loss alert, logs global win/loss
                function winLose() {
                        ...
                        // Cycle through trivia until player wins 11th game
                                if (globalWins < trivia.length) {
                                        doModal("You win!", trivia[globalWins]);
                                } else {
                        // After player's 11th win, default to last element of trivia array
                                        doModal("You win!", trivia[trivia.length-1]);
                                }
                                globalWins++;
                                document.querySelector("#globalWins").innerHTML = ("Wins: " + globalWins);
                        } else if (counter > targetScore) {
                        // When player loses, give them a fairy to allow them to try again
